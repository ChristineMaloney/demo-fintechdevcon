...
/**
 * Flips an order to 'paid' once the payment provider has confirmed the
 * transaction server-side. `payment` is the provider's own summary, kept
 * alongside the order so the confirmation page can show it.
 */
export function markOrderPaid(orderNumber, payment) {
